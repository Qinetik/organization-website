...
export default function PrivacyPage() {
    return (
        <PageContainer>
            <PaddedColumn>
                <h2>Privacy Privacy for Qinetik</h2>
                ...
                <Paragraph>We use the information we collect in various ways, including
                    to:</Paragraph>
                ...
                <Paragraph>For more general information on cookies, please read.</Paragraph>

                <h3>Advertising Partners Privacy Policies</h3>

                <Paragraph>
                    You may consult this list to find the Privacy Privacy for each of the
                    advertising partners of Qinetik.
                </Paragraph>

                <Paragraph>
                    Third-party ad servers or ad networks uses technologies like
                    cookies, JavaScript, or Web Beacons that are used in their
                    respective advertisements and links that appear on Qinetik, which
                ...
                <Paragraph>
                    Note that Qinetik has no access to or control over these cookies
                ...
                <Paragraph>
                    Qinetik's Privacy Privacy does not apply to other advertisers or
