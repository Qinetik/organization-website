...
import {MindNodeIcon, PhotoEditorIcon, TimelineIcon} from "../icons/AppIcons.tsx";
        ...
        <Container>
            ...
            <CenteredColumn>
                ...
                <CenteredColumn gap={"4rem"} style={{padding: "3rem 6rem", background : Anique.colors.onBg200 }}>
                    ...
                    <CenteredColumn>
                        <h1 style={{"margin-bottom": "0", color : Anique.colors.bg200}}>Why Choose Qinetik's App Solutions</h1>
                ...
                <div style={{ padding : "6rem" }}>
                    <Row style={{ "padding": "4rem", background : Anique.colors.bg200, "border-radius" : Anique.border.mdRadius }} gap={"4em"}>
                        <Column>
                            <h1>Like our service? Subscribe us</h1>
                            <p>We will send you emails (only the important stuff) about our new products and services</p>
                        </Column>
                        <Row gap={"1em"}>
                            <MainField
                                placeholder={"Enter your email address"}
