public func MenuIcon(page : &mut HtmlPage, fill : std::string_view = "currentColor") {
    #html {
        <svg viewBox="0 0 24 24" fill={fill} width="24" height="24">
            <title>menu</title>
...
public func LightDarkIcon(page : &mut HtmlPage, fill : std::string_view = "currentColor") {
    #html {
        <svg width="24" height="24" viewBox="0 0 60 60" fill={fill}>
